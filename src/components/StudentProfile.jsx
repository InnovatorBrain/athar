...
export default function StudentProfile() {
    ...
    const fetchProfile = async () => {
      try {
        ...
        const [profileRes, studentProfileRes] = await Promise.all([
          ...
          axios.get('http://127.0.0.1:8000/auth/student/profile/')
        ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('http://127.0.0.1:8000/auth/profile/picture/', data);
      await axios.post('http://127.0.0.1:8000/auth/student/profile/', formData);
